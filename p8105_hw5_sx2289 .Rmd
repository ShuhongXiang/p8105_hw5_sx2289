...
```
From the bar char above, we can see the power of test increase with the the true value of mu.The proportion of rejecting null reach 1 when mu greater than 3. 

### Make a plot showing the average estimate of estimated mu on the y axis and the true value of mu on the x axis. Make a second plot (or overlay on the first) the average estimate of estimated mu only in samples for which the null was rejected on the y axis and the true value of mu on the x axis. 
